...
const serviceData = [
...

    {
        ...
        priceFrom: "100,000円〜",
        // 価格の直上に置く成果実績。規模の指標しか無いと言い値に見えるため。
        // 引用時の制約：「新規流入」を「新規ダウンロード」に言い換えない／
        // 同接数と併記しない／割り算して見せない／許諾の一文を必ず添える
        proof: "PR配信実績：同時接続者数ベースで約40%が新規流入（クライアント様より許諾を得ております）",
        // 内訳は非公開。上端に数字を置かず、価格調整ファクター
        //（リスクプレミアム／無期限掲載／二次利用）を交渉余地として残す
        items: [
            { price: "100,000円〜" }
        ],
        note: "※内容・期間・二次利用の有無により変動します。",
        worksLimit: 3
    }
